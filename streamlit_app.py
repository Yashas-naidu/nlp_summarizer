...
#     st.markdown("<h4 style='text-align: center; color:grey;'>Accelerate knowledge with Research et al &#129302;</h4>", unsafe_allow_html=True)
#     st.text('')
#     p_title('Summarize')
#     st.text('')
...
#                     summary_ids = model.generate(inputs, max_length=10000, min_length=1000, length_penalty=2.0, num_beams=4, early_stopping=True)
...
# if nav == 'Analyze text':
#     st.markdown("<h4 style='text-align: center; color:grey;'>Accelerate knowledge with Research-et-all &#129302;</h4>", unsafe_allow_html=True)
#     st.text('')
        ...
        if st.button('Summarize'):
            if len(input_su) < 1000:
                ...
                with st.spinner('Processing...'):
                    ...
                    inputs = tokenizer(input_su, max_length=1024, return_tensors="pt", truncation=True)
